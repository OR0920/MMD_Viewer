...
namespace MMDsdkTest
{
	...
	{
		const char* testPmdModelPath = "TestModel/Model/初音ミクVer2.pmd";
		...
		TEST_METHOD(ReadPmd)
		{
			...
			Assert::IsTrue(StringEqual(pmd.GetDirectoryPath(), "TestModel/Model/"));
			...
			Assert::IsTrue(m0.texturePath.GetText()[0] == '\0');
