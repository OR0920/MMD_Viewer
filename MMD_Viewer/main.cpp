...
int main()
{
	...
	newArray_CreateWideCharStrFromMultiByteStr(&text, "日本語ですよ, I'm English");
	DebugMessageWide(text);
	SafeDeleteArray(&text);

	wchar_t* wText = nullptr;
	newArray_CreateWideCharStrFromMultiByteStr(reinterpret_cast<char16_t**>(&wText), "日本語ですよ, I'm English");
